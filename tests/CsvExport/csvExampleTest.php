...
class csvExampleTest extends TestCase
{
     ...
     * @var array
     */
    protected $rows_values = array(array("ce1r1c1", "e1r1c2", "e1r1c3"),
                                   array("ae1r2c1", "e1r2c2", "e1r2c3"),
                                   array("be1r3c1", "e1r3c2", "e1r3c3")
    );
    /**
     * @var array
     */
    protected $rows_paired = array(array("column1" => "e2r1c1", "column2" => "e2r1c2", "column3" => "e2r1c3"),
                                   array("column1" => "e2r2c1", "column3" => "e2r2c3"),
    ...
    public function testAddFromArray()
    {
        ...
        $this->assertEquals($this->csvExport->getTable()->getColumns()->getColumnNamesAsArray(),
            Array('column1' => 'column1', 'column2' => 'column2', 'column3' => 'column3'));
