...
include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartLegend.php";
...
abstract class ilChart50
{
	...
	{		
		...
		{
			case self::TYPE_GRID:
				include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartGrid.php";
				return new ilChartGrid50($a_id);
				
			case self::TYPE_PIE:
				include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartPie.php";
				return new ilChartPie50($a_id);
				
			case self::TYPE_SPIDER:
				include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartSpider.php";
				return new ilChartSpider50($a_id);
		}				
	}
	 ...
	 * @return bool
	 */
	abstract protected function isValidDataType(ilChartData50 $a_series);
	 ...
	 * Add data series
	 *
	 * @param ilChartData50 $a_series
	 * @param mixed $a_id
	 * @return mixed index
	 */
	public function addData(ilChartData50 $a_series, $a_idx = null)
	{
	 ...
	 * Set chart legend
	 *
	 * @param ilChartLegend50 $a_legend
	 */
	public function setLegend(ilChartLegend50 $a_legend)
	{
	...
	protected function initJS()
	{
		...
		$tpl->addJavascript("Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/js/flot/excanvas.min.js");
		$tpl->addJavascript("Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/js/flot/jquery.flot.min.js");
		
		if((bool)$this->auto_resize)
		{
			// #13108
			$tpl->addJavascript("Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/js/flot/jquery.flot.resize.min.js");
		}
	...
	{		
		...
		$chart = new ilTemplate("tpl.grid.html", true, true, "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart");
