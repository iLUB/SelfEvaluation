...
include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartData.php";
 ...
 */
class ilChartDataSpider50 extends ilChartData50
{
	...
	public function parseData(array &$a_data)
	{
		...
		if ($fill["color"] != "")
		{
			$a_data[0]->color = ilChart50::renderColor($fill["color"] , "0.5");
		}
	}

	public function parseGlobalOptions(stdClass $a_options, ilChart50 $a_chart)
	{
		$spider = new stdClass();
		$spider->active = true;
		...
		$spider->legs->fillStyle = ilChart50::renderColor("#000", 0.7);
