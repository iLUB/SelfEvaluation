...
class ilChartLegend50
{
	...
	{
		if(ilChart50::isValidColor($a_color))
		{
	...
	public function parseOptions(stdClass $a_options)
	{
		...
		$a_options->backgroundColor = ilChart50::renderColor($this->getBackground());
		$a_options->backgroundOpacity = str_replace(",",".",$this->getOpacity());
		$a_options->labelBoxBorderColor = ilChart50::renderColor($this->getLabelBorder());
