 ...
 */
class ilChartSpider50 extends ilChart50
{
	...
	{
		include_once "Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/classes/class.ilChartDataSpider.php";
		return new ilChartDataSpider50();
	}

	protected function isValidDataType(ilChartData50 $a_series)
	{
		return ($a_series instanceof ilChartDataSpider50);
	}
	...
	protected function addCustomJS()
	{
		...
		$tpl->addJavascript("Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/js/flot/jquery.flot.highlighter.js");
		$tpl->addJavascript("Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/Feedback/Chart/js/flot/jquery.flot.spider.js");
	}
	...
	public function parseGlobalOptions(stdClass $a_options)
	{
		...
		$a_options->grid->tickColor = ilChart50::renderColor("#000", 0.1);
