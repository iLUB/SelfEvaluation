...
class iLubFieldDefinitionTableGUI extends ilTable2GUI {
	...
	public function __construct($a_parent_obj, $a_parent_cmd, $types, $sortable) {
		...
		$this->setRowTemplate('tpl.field_def_data_table_row.html', 'Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/iLubFieldDefinition/');
	}
