<?php
require_once('class.srModelObjectList.php');
/**
 * Class srModelObject
 *
...
abstract class srModelObject {
	 ...
	 * @param $id
	 *
	 * @return srModelObject
	 */
	public static function find($id) {
		$class = get_called_class();
		/**
		 * @var $obj srModelObject
		 */
	...
	public static function where($where, $operator = NULL) {
		$srModelObjectList = new srModelObjectList(get_called_class());
	...
	//
	/**
	 * @param srModelObject $obj
	 *
	 * @return bool
	 * @throws Exception
	 */
	private static function setDBFields(srModelObject $obj) {
