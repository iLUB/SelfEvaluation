...
class ilubTranslatedStringWithDefaultsInputGUI extends ilubTranslatedStringInputGUI {
	...
	public function insert(&$a_tpl) {
		...
		foreach ($this->sub_items as $item) {
			...
			$title_tpl = new ilTemplate('Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/InputGUIs/templates/tpl.ilub_translated_string_with_default_text_input.html', TRUE, TRUE);
