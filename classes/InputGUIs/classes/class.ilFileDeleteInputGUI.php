...
class ilFileDeleteInputGUI extends ilFormPropertyGUI
{
    ...
    public function render($a_mode = '')
    {
        /** @var ilCtrl $ilCtrl */
        global $ilCtrl;
        $delete_tpl = new ilTemplate('Customizing/global/plugins/Services/Repository/RepositoryObject/SelfEvaluation/classes/InputGUIs/templates/tpl.delete_files.html',
            true, true);
        ...
        foreach ($this->files as $file) {
            ...
            if ($this->getTargetClass() != '' AND $this->isDownloadAllowed()) {
                ...
                $delete_tpl->setVariable('LINK',
                    $ilCtrl->getLinkTargetByClass($this->getTargetClass(), 'downloadFile'));
